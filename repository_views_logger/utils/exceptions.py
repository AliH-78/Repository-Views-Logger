...
def handle_repository_views_exception_traceback(repository):
    console.repository_views_logger_error(repository, message = "[!] An error occured at Repository Views Logger thread and thread been terminated. More information available at the log file.")

    log_module_traceback("REPO_VIEWS_LOGGER", repository)

def handle_popular_files_views_exception_traceback(repository):
    console.popular_files_views_logger_error(repository, message = "[!] An error occured at Popular Files' Views Logger thread and thread been terminated. More information available at the log file.")
